...
/*   Updated: 2022/08/18 15:30:27 by jmehlig          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(Form const &f)
{
    ...
    {
        f.execute(*this);
        std::cout << "The bureaucrat " << name << " executed " << f.getName() << "!\n";
    }
    catch (Form::FormNotSignedException)
    {
        std::cout << "The bureaucrat " << name << " couldn't execute " << f.getName() << ", since it was not signed!\n";
    }
    catch (Form::GradeTooLowException)
    {
        std::cout << "The bureaucrat " << name << " couldn't execute " << f.getName() << ", since its grade was too low!\n";
    }
}
